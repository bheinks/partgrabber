...
<body>
	...
	<p style="font-weight: bold; font-size: 22px; text-align: center;">CPUs</p>	
	
	<div style="text-align: center;">
		<form action="cpu.php?build_name=<?=$build_name?>" method="POST">
		...
		<?php
			...
			if($search_field != ""){
				$sql = $sql." AND (
					...
					OR architecture LIKE('%".$search_field."%')						
				);";				
			}
						...
						echo "<table border>";
							...
							while($row2 = $result2->fetch_array()){
								echo "<tr>";
									...
									echo "<td style='width:80px; text-align:right'>$".$row2["price"]."</td>";
									echo "<td style='width:90px; text-align:right'><a href='addpartredirect.php?
